    ...
    if(!Dates.box){
        ...
        div.innerHTML =  log.html = '<div class="laydate_top">'
          +'<div class="laydate_ym laydate_y" id="laydate_YY">'
            +'<a class="laydate_choose laydate_chprev laydate_tab"><img src="/static/img/icon_left.png" /></a>'
            +'<input id="laydate_y" readonly>'
            +'<a class="laydate_choose laydate_chnext laydate_tab"><img src="/static/img/icon_right.png" /></a>'
            +'<div class="laydate_yms">'
              +'<a class="laydate_tab laydate_chtop"></a>'
              +'<ul id="laydate_ys"></ul>'
              +'<a class="laydate_tab laydate_chdown"></a>'
            +'</div>'
          +'</div>'
