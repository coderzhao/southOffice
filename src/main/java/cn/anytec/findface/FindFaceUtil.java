...
public class FindFaceUtil {
    private final Logger logger = Logger.getLogger(FindFaceUtil.class);
    private static final FindFaceUtil findFaceUtil = new FindFaceUtil();
    public static FindFaceUtil getInstance(){
        return findFaceUtil;
    }
